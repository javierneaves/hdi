...
export function formAuto(formData) {
  ...
  let dataArray;
      ...
      button1.type = "button";
      button1.className = "btn btn-outline-secondary vehicleBtn p-2";
      ...
      button2.type = "button";
      button2.className = "btn btn-outline-secondary vehicleBtn p-2";
      ...
      selectYear.addEventListener("change", function (e) {
        ...
        marcaFiltered.forEach((objeto) => {
          ...
          marcaClave.push(objeto[1]);
				...
				marcaUnica = marcaClave.filter((valor, indice, array) => array.indexOf(valor) === indice);
      ...
      selectBrand.addEventListener('change', function (e) {
        ...
        modelFiltered.forEach((objeto) => {
          ...
          modelClave.push(objeto[2]);
				...
				const modelUnica = modelClave.filter((valor, indice, array) => array.indexOf(valor) === indice);
