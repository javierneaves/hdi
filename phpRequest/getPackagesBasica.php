<?php
// Se hace un ciclo para obtener cada uno de los paquetes (BASICO, LIMITADO, AMPLIO)
...
function procesarDatos($data)
{
  ...
  if (isset($data['vehicleData']) && count($data['vehicleData']) > 0) {
    ...
    <asmx:datosVehiculo>
    <asmx:idVehiculo>' . $clave . '</asmx:idVehiculo>
    <asmx:idMarca>0</asmx:idMarca>
    <asmx:idModelo>' . $modeloLlave . '</asmx:idModelo>
    <asmx:idTipo/>
    <asmx:idVersion/>
    <asmx:idTransmision>0</asmx:idTransmision>
    <asmx:idUso>' . $idUso . '</asmx:idUso>
    <asmx:tipoVehiculo>' . $idTipoVehiculoClave . '</asmx:tipoVehiculo>
    ...
    <asmx:CPCirculacion>64620</asmx:CPCirculacion>
    </asmx:DatosAdicionales>
    </asmx:datosVehiculo>
    ...
    <asmx:Clave>22</asmx:Clave>
    <asmx:Descripcion>BASICA</asmx:Descripcion>
    <asmx:Vigencia>
